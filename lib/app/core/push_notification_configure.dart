...
import 'package:flutter_push_notification_strategy/app/core/push_notification_strategies/push_notification_factory.dart';
...
class PushNotificationConfigure {
  ...
  Future<void> configure() async {
    ...
    var androidPlatformChannelSpecifics =
        AndroidNotificationDetails('push_notification_strategy', 'push_notification_strategy_name', 'push_notification_strategy_description', importance: Importance.Max, priority: Priority.High, ticker: 'ticker');
